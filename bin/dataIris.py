...
def runDataIris():
  ...
  mbgddi = MiniBatchGradientDescent(max_iter = 200, batch_size = 10, error_threshold = 0.0001, learning_rate = 0.5, n_layer = 3, n_neuron_per_layer = [4, 3, 3], activation_function_name_per_layer = ['none', 'sigmoid', 'sigmoid'])
